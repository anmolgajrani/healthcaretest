...
contract Record {
    ...
    function setDetails(
        ...
        Patients p = patients[msg.sender];
    ...
    function setAppointment(
        ...
        require(isDoctor[msg.sender]);
        Appointments a = appointments[_addr];
    ...
    function searchPatientDemographic(address _address)
        public
        view
        returns (
            string,
        ...
        )
    {
        ...
        Patients p = patients[_address];

        return (p.ic, p.name, p.phone, p.gender, p.dob, p.height, p.weight);
    }

    //Search patient details by entering a patient address (Only record owner or doctor with permission will be allowed to access)
    function searchPatientMedical(address _address)
        public
        view
        returns (
            string,
    ...
    function searchDoctor(address _address)
        public
        view
        returns (
            string,
    ...
    function searchAppointment(address _address)
        public
        view
        returns (
            address,
    ...
    {
        Appointments a = appointments[_address];
        Doctors d = doctors[a.doctoraddr];
    ...
    function searchAppointmentDate(address _address)
        public
        view
        returns (uint256)
    {
    ...
    //Retrieve permission granted count
    function getAppointmentPerPatient(address _address)
        public
        view
        returns (uint256)
    {
